...
const Home = ()=>{
    return(
        <main className="flex flex-col gap-20 ">
            <header className="flex-col px-5 h-auto mt-16  " id="home">
                <div className=" flex flex-col justify-between gap-5 mb-5">
                    <h1 className="text-3xl text-center">Effortlessly <span className="text-indigo-500">Organize and Complete</span> Your Tasks</h1>
                    <h3 className="text-black/60 text-sm text-center">We created an app to help you stay on top of your tasks effortlessly. Organize, track, and prioritize with ease so you can stay focused and productive every day.</h3>
                    <div>
            ...
            <section className="px-5  flex flex-col gap-5" id="services">
                <div>
            ...
            <section className="bg-indigo-100/50 p-5 flex-col">
            ...
            <section className="p-5 flex-col " id="about">
                <aside className="flex-col gap-10">
